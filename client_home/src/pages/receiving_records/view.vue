          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','order_number') || ($check_field('add','order_number') || $check_field('set','order_number'))" label="订单号" name="order_number">
                            <uni-easyinput type="text" v-model="form['order_number']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','order_number')) || (!form['receiving_records_id'] && $check_field('add','order_number'))"  :disabled="true" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','trade_name') || ($check_field('add','trade_name') || $check_field('set','trade_name'))" label="商品名称" name="trade_name">
                            <uni-easyinput type="text" v-model="form['trade_name']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','trade_name')) || (!form['receiving_records_id'] && $check_field('add','trade_name'))" :disabled="disabledObj['trade_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','product_type') || ($check_field('add','product_type') || $check_field('set','product_type'))" label="商品类型" name="product_type">
                            <uni-easyinput type="text" v-model="form['product_type']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','product_type')) || (!form['receiving_records_id'] && $check_field('add','product_type'))" :disabled="disabledObj['product_type_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','specifications') || ($check_field('add','specifications') || $check_field('set','specifications'))" label="规格" name="specifications">
                            <uni-easyinput type="text" v-model="form['specifications']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','specifications')) || (!form['receiving_records_id'] && $check_field('add','specifications'))" :disabled="disabledObj['specifications_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','supplier_user') || ($check_field('add','supplier_user') || $check_field('set','supplier_user'))" label="供货商用户" name="supplier_user">
                  ...
                  v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','supplier_user')) || (!form['receiving_records_id'] && $check_field('add','supplier_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['supplier_user']"
                  :localdata="list_user_supplier_user"
              ...
              <uni-forms-item v-if="$check_field('get','supplier_name') || ($check_field('add','supplier_name') || $check_field('set','supplier_name'))" label="供货商名" name="supplier_name">
                            <uni-easyinput type="text" v-model="form['supplier_name']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','supplier_name')) || (!form['receiving_records_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','price') || ($check_field('add','price') || $check_field('set','price'))" label="价格" name="price">
                            <uni-easyinput type="text" v-model="form['price']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','price')) || (!form['receiving_records_id'] && $check_field('add','price'))" :disabled="disabledObj['price_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','order_quantity') || ($check_field('add','order_quantity') || $check_field('set','order_quantity'))" label="订购数量" name="order_quantity">
                            <uni-easyinput type="text" v-model="form['order_quantity']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','order_quantity')) || (!form['receiving_records_id'] && $check_field('add','order_quantity'))" :disabled="disabledObj['order_quantity_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','order_amount') || ($check_field('add','order_amount') || $check_field('set','order_amount'))" label="订购金额" name="order_amount">
                            <uni-easyinput type="text" v-model="form['order_amount']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','order_amount')) || (!form['receiving_records_id'] && $check_field('add','order_amount'))"  @focus="set_order_amount()" :disabled="disabledObj['order_amount_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','whether_to_identify') || ($check_field('add','whether_to_identify') || $check_field('set','whether_to_identify'))" label="是否鉴定" name="whether_to_identify">
                            <uni-easyinput type="text" v-model="form['whether_to_identify']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','whether_to_identify')) || (!form['receiving_records_id'] && $check_field('add','whether_to_identify'))" :disabled="disabledObj['whether_to_identify_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','appraisal_fees') || ($check_field('add','appraisal_fees') || $check_field('set','appraisal_fees'))" label="鉴定费用" name="appraisal_fees">
                            <uni-easyinput type="text" v-model="form['appraisal_fees']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','appraisal_fees')) || (!form['receiving_records_id'] && $check_field('add','appraisal_fees'))" :disabled="disabledObj['appraisal_fees_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','total_amount') || ($check_field('add','total_amount') || $check_field('set','total_amount'))" label="总金额" name="total_amount">
                            <uni-easyinput type="text" v-model="form['total_amount']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','total_amount')) || (!form['receiving_records_id'] && $check_field('add','total_amount'))"  @focus="set_total_amount()" :disabled="disabledObj['total_amount_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || ($check_field('add','user_name') || $check_field('set','user_name'))" label="用户名称" name="user_name">
                  ...
                  v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','user_name')) || (!form['receiving_records_id'] && $check_field('add','user_name'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_name']"
                  :localdata="list_user_user_name"
              ...
              <uni-forms-item v-if="$check_field('get','pickup_method') || ($check_field('add','pickup_method') || $check_field('set','pickup_method'))" label="取货方式" name="pickup_method">
                            <uni-easyinput type="text" v-model="form['pickup_method']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','pickup_method')) || (!form['receiving_records_id'] && $check_field('add','pickup_method'))" :disabled="disabledObj['pickup_method_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','consignee') || ($check_field('add','consignee') || $check_field('set','consignee'))" label="收货人" name="consignee">
                            <uni-easyinput type="text" v-model="form['consignee']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','consignee')) || (!form['receiving_records_id'] && $check_field('add','consignee'))" :disabled="disabledObj['consignee_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','receiving_phone_number') || ($check_field('add','receiving_phone_number') || $check_field('set','receiving_phone_number'))" label="收货电话" name="receiving_phone_number">
                            <uni-easyinput type="text" v-model="form['receiving_phone_number']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','receiving_phone_number')) || (!form['receiving_records_id'] && $check_field('add','receiving_phone_number'))" :disabled="disabledObj['receiving_phone_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','shipping_address') || ($check_field('add','shipping_address') || $check_field('set','shipping_address'))" label="收货地址" name="shipping_address">
                            <uni-easyinput type="text" v-model="form['shipping_address']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','shipping_address')) || (!form['receiving_records_id'] && $check_field('add','shipping_address'))" :disabled="disabledObj['shipping_address_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','shipping_address')">
                  {{ form['shipping_address'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','receiving_time') || ($check_field('add','receiving_time') || $check_field('set','receiving_time'))" label="收货时间" name="receiving_time">
                    <uni-datetime-picker v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','receiving_time')) || (!form['receiving_records_id'] && $check_field('add','receiving_time'))" v-model="form['receiving_time']" type="date" :disabled="disabledObj['receiving_time_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','receiving_time')">
                  {{ form['receiving_time'] }}
                </text>
                  </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','receiving_remarks') || ($check_field('add','receiving_remarks') || $check_field('set','receiving_remarks'))" label="收货备注" name="receiving_remarks">
                    <uni-easyinput type="textarea" v-model="form['receiving_remarks']" v-if="user_group === '管理员' || (form['receiving_records_id'] && $check_field('set','receiving_remarks')) || (!form['receiving_records_id'] && $check_field('add','receiving_remarks'))" :disabled="disabledObj['receiving_remarks_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','receiving_remarks')">
                  {{ form['receiving_remarks'] }}
                </text>
                  </uni-forms-item>
    ...
    return {
      ...
      form: {
            "order_number": this.$get_stamp(), // 订单号
                    ...
                    "receiving_time": this.$toTime(new Date().getTime(), "yyyy-MM-dd"),
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/receiving_records/upload?'),
    ...
    get_obj_before(param){
      ...
      for (var i=0;i<arr.length;i++){
        this.disabledObj[arr[i] + '_isDisabled'] = true
                                                                                                                                                      ...
                                                                                                                                                      if (this.form["receiving_time"] && JSON.stringify(this.form["receiving_time"]).indexOf("-")===-1) {
