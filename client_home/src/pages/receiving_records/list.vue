<template>
	<view class="page_receiving_records diy_list diy_list_page div_list_tml" id="receiving_records_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索订单号" @confirm="search" @cancel="cancel" cancelText="取消"
								...
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
																														...
																														<uni-search-bar placeholder="搜索取货方式" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'pickup_method')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																		<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?receiving_records_id=' + o['receiving_records_id']" class="btn btn-primary">查看详情</navigator>
...
<script>
	 ...
	 */
	to_nav(id) {
		this.$nav('/pages/receiving_records/details?receiving_records_id=' + id)
	},
