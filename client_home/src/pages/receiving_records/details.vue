<template>
	<view class="page_receiving_records diy_detail diy_detail--new" id="receiving_records_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','order_quantity')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>订购数量</span>
							</view>
					...
					<view v-if="$check_field('get','order_amount')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>订购金额</span>
							</view>
					...
					<view v-if="$check_field('get','whether_to_identify')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>是否鉴定</span>
							</view>
					...
					<view v-if="$check_field('get','appraisal_fees')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>鉴定费用</span>
							</view>
					...
					<view v-if="$check_field('get','total_amount')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>总金额</span>
							</view>
					...
					<view v-if="$check_field('get','pickup_method')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>取货方式</span>
							</view>
					...
					<view v-if="$check_field('get','receiving_time')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>收货时间</span>
							</view>
					...
					<view v-if="$check_field('get','receiving_remarks')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>收货备注</span>
							</view>
		...
		<view class="warp">
			<view class="container-fluid container-fluid-comment--new">
				<view class="row">
					<view class="col">
									<button type="button" class="btn btn-primary" v-if="$check_action('/after_sales_application/edit','add')" @click="to_form('/pages/after_sales_application/edit')">
							<span>售后申请</span>
						</button>
