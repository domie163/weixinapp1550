          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','trade_name') || ($check_field('add','trade_name') || $check_field('set','trade_name'))" label="商品名称" name="trade_name">
                            <uni-easyinput type="text" v-model="form['trade_name']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','trade_name')) || (!form['cancellation_of_order_id'] && $check_field('add','trade_name'))" :disabled="disabledObj['trade_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','product_type') || ($check_field('add','product_type') || $check_field('set','product_type'))" label="商品类型" name="product_type">
                            <uni-easyinput type="text" v-model="form['product_type']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','product_type')) || (!form['cancellation_of_order_id'] && $check_field('add','product_type'))" :disabled="disabledObj['product_type_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','supplier_user') || ($check_field('add','supplier_user') || $check_field('set','supplier_user'))" label="供货商用户" name="supplier_user">
                  ...
                  v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','supplier_user')) || (!form['cancellation_of_order_id'] && $check_field('add','supplier_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['supplier_user']"
                  :localdata="list_user_supplier_user"
              ...
              <uni-forms-item v-if="$check_field('get','supplier_name') || ($check_field('add','supplier_name') || $check_field('set','supplier_name'))" label="供货商名" name="supplier_name">
                            <uni-easyinput type="text" v-model="form['supplier_name']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','supplier_name')) || (!form['cancellation_of_order_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','price') || ($check_field('add','price') || $check_field('set','price'))" label="价格" name="price">
                            <uni-easyinput type="text" v-model="form['price']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','price')) || (!form['cancellation_of_order_id'] && $check_field('add','price'))" :disabled="disabledObj['price_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','order_quantity') || ($check_field('add','order_quantity') || $check_field('set','order_quantity'))" label="订购数量" name="order_quantity">
                            <uni-easyinput type="text" v-model="form['order_quantity']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','order_quantity')) || (!form['cancellation_of_order_id'] && $check_field('add','order_quantity'))" :disabled="disabledObj['order_quantity_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','order_amount') || ($check_field('add','order_amount') || $check_field('set','order_amount'))" label="订购金额" name="order_amount">
                            <uni-easyinput type="text" v-model="form['order_amount']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','order_amount')) || (!form['cancellation_of_order_id'] && $check_field('add','order_amount'))"  @focus="set_order_amount()" :disabled="disabledObj['order_amount_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','total_amount') || ($check_field('add','total_amount') || $check_field('set','total_amount'))" label="总金额" name="total_amount">
                            <uni-easyinput type="text" v-model="form['total_amount']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','total_amount')) || (!form['cancellation_of_order_id'] && $check_field('add','total_amount'))"  @focus="set_total_amount()" :disabled="disabledObj['total_amount_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || ($check_field('add','user_name') || $check_field('set','user_name'))" label="用户名称" name="user_name">
                  ...
                  v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','user_name')) || (!form['cancellation_of_order_id'] && $check_field('add','user_name'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_name']"
                  :localdata="list_user_user_name"
              ...
              <uni-forms-item v-if="$check_field('get','reason_for_cancellation') || ($check_field('add','reason_for_cancellation') || $check_field('set','reason_for_cancellation'))" label="取消原因" name="reason_for_cancellation">
                    <uni-easyinput type="textarea" v-model="form['reason_for_cancellation']" v-if="user_group === '管理员' || (form['cancellation_of_order_id'] && $check_field('set','reason_for_cancellation')) || (!form['cancellation_of_order_id'] && $check_field('add','reason_for_cancellation'))" :disabled="disabledObj['reason_for_cancellation_isDisabled']" />
                <!-- 仅查看 -->
