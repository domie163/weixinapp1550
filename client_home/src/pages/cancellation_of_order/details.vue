<template>
	<view class="page_cancellation_of_order diy_detail diy_detail--new" id="cancellation_of_order_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','reason_for_cancellation')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>取消原因</span>
							</view>
