<template>
  <view class="page_reply_record diy_table diy_table_tml" id="reply_record_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/reply_record/view?" v-show="user_group == '管理员' || $check_action('/reply_record/table','add') || $check_action('/reply_record/view','add')">添加</navigator>
                            ...
                            <span>咨询主题</span>
								...
								<text>
									{{ o["consultation_topic"] }}
													...
													<view v-if="0 && $check_field('get','reply_content')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>回复内容</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/reply_record/table','del') || $check_action('/reply_record/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/reply_record/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/reply_record/table','set') || $check_action('/reply_record/view','set') || $check_action('/reply_record/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
