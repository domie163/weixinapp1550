          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','supplier_user') || ($check_field('add','supplier_user') || $check_field('set','supplier_user'))" label="供货商用户" name="supplier_user">
                            <uni-easyinput type="text" v-model="form['supplier_user']" v-if="user_group === '管理员' || (form['supplier_id'] && $check_field('set','supplier_user')) || (!form['supplier_id'] && $check_field('add','supplier_user'))" :disabled="disabledObj['supplier_user_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','supplier_user')">
                  {{ form['supplier_user'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','supplier_name') || ($check_field('add','supplier_name') || $check_field('set','supplier_name'))" label="供货商名" name="supplier_name">
                            <uni-easyinput type="text" v-model="form['supplier_name']" v-if="user_group === '管理员' || (form['supplier_id'] && $check_field('set','supplier_name')) || (!form['supplier_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/supplier/upload?'),
