					...
					<navigator  :url="'/pages/product_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/product_information/table','set') || $check_action('/product_information/view','set') || $check_action('/product_information/view','get')" class="btn btn-primary">详情</navigator>
									...
									<span>预约订单</span>
															...
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/live_booking/view','add')" @click="to_form('/pages/live_booking/view',o)">
									<span>直播预约</span>
								</a>
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/consultation_records/view','add')" @click="to_form('/pages/consultation_records/view',o)">
									<span>咨询商家</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                    // 商品类型列表
                list_product_type: [{value:"",text:"全部"}],
                                            // 库存列表
                list_stock: [{value:"",text:"全部"}],
                                                // 用户列表
