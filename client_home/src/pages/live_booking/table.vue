<template>
  <view class="page_live_booking diy_table diy_table_tml" id="live_booking_table">
    <!-- 筛选模块(开始) -->
    <view>
                  ...
                  <uni-forms-item label="商品名称" name="trade_name">
                    ...
                    <uni-forms-item label="商品类型" name="product_type">
                      <uni-easyinput type="text" v-model="query.product_type" placeholder="商品类型" />
                            ...
                            <uni-forms-item label="供货商名" name="supplier_name">
                      <uni-easyinput type="text" v-model="query.supplier_name" placeholder="供货商名" />
                    </uni-forms-item>
                        </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/live_booking/view?" v-show="user_group == '管理员' || $check_action('/live_booking/table','add') || $check_action('/live_booking/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','time_of_appointment')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>预约时间</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','live_streaming_plan')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>直播计划</span>
							</view>
															<view class="diy_field diy_text text">
								<span>
									{{ o["live_streaming_plan"] }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','live_remarks')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>直播备注</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/live_booking/table','del') || $check_action('/live_booking/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/live_booking/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/live_booking/table','set') || $check_action('/live_booking/view','set') || $check_action('/live_booking/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
