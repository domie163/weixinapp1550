<template>
  <view class="page_after_sales_results diy_table diy_table_tml" id="after_sales_results_table">
    <!-- 筛选模块(开始) -->
    <view>
                  ...
                  <uni-forms-item label="订单号" name="order_number">
                    ...
                    <uni-forms-item label="商品名称" name="trade_name">
                      <uni-easyinput type="text" v-model="query.trade_name" placeholder="商品名称" />
                                    ...
                                    <uni-forms-item label="售后问题" name="after_sales_issues">
                      <uni-easyinput type="text" v-model="query.after_sales_issues" placeholder="售后问题" />
                    </uni-forms-item>
                    </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/after_sales_results/view?" v-show="user_group == '管理员' || $check_action('/after_sales_results/table','add') || $check_action('/after_sales_results/view','add')">添加</navigator>
                            ...
                            <span>订单号</span>
								...
								<text>
									{{ o["order_number"] }}
													...
													<view v-if="1 && $check_field('get','trade_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商品名称</span>
                          </view>
								...
								<text>
									{{ o["trade_name"] }}
													...
													<view v-if="0 && $check_field('get','product_type')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商品类型</span>
                          </view>
								...
								<text>
									{{ o["product_type"] }}
													...
													<view v-if="0 && $check_field('get','supplier_user')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>供货商用户</span>
                          </view>
								...
								<text>
									{{ get_user_supplier_user(o['supplier_user']) }}
													...
													<view v-if="0 && $check_field('get','supplier_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>供货商名</span>
                          </view>
								...
								<text>
									{{ o["supplier_name"] }}
													...
													<view v-if="0 && $check_field('get','after_sales_quantity')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>售后数量</span>
                          </view>
                            ...
                            <span>用户名称</span>
								...
								<text>
									{{ get_user_user_name(o['user_name']) }}
													...
													<view v-if="0 && $check_field('get','consignee')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>收货人</span>
                          </view>
								...
								<text>
									{{ o["consignee"] }}
													...
													<view v-if="0 && $check_field('get','receiving_phone_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>收货电话</span>
                          </view>
                            ...
                            <span>收货地址</span>
								...
								<text>
									{{ o["shipping_address"] }}
													...
													<view v-if="0 && $check_field('get','after_sales_issues')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>售后问题</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["after_sales_issues"] }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="1 && $check_field('get','after_sales_processing')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>售后处理</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["after_sales_processing"] }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','after_sales_remarks')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>售后备注</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/after_sales_results/table','del') || $check_action('/after_sales_results/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/after_sales_results/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/after_sales_results/table','set') || $check_action('/after_sales_results/view','set') || $check_action('/after_sales_results/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/after_sales_results/get_list?like=0",
				url_del: "~/api/after_sales_results/del?",
