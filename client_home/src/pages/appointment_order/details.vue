<template>
	<view class="page_appointment_order diy_detail diy_detail--new" id="appointment_order_details">
		<view class="warp">
		...
		<view class="warp">
			<view class="container-fluid container-fluid-comment--new">
				<view class="row">
					<view class="col">
									<button type="button" class="btn btn-primary" v-if="$check_action('/receiving_records/edit','add')" @click="to_form('/pages/receiving_records/edit')">
							<span>收货确认</span>
						</button>
								<button type="button" class="btn btn-primary" v-if="$check_action('/cancellation_of_order/edit','add')" @click="to_form('/pages/cancellation_of_order/edit')">
							<span>取消订单</span>
						</button>
