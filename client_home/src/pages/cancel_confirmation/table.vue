<template>
  <view class="page_cancel_confirmation diy_table diy_table_tml" id="cancel_confirmation_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/cancel_confirmation/view?" v-show="user_group == '管理员' || $check_action('/cancel_confirmation/table','add') || $check_action('/cancel_confirmation/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','reason_for_cancellation')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>取消原因</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/cancel_confirmation/table','del') || $check_action('/cancel_confirmation/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/cancel_confirmation/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/cancel_confirmation/table','set') || $check_action('/cancel_confirmation/view','set') || $check_action('/cancel_confirmation/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
