          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','order_number') || ($check_field('add','order_number') || $check_field('set','order_number'))" label="订单号" name="order_number">
                            <uni-easyinput type="text" v-model="form['order_number']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','order_number')) || (!form['after_sales_application_id'] && $check_field('add','order_number'))" :disabled="disabledObj['order_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','trade_name') || ($check_field('add','trade_name') || $check_field('set','trade_name'))" label="商品名称" name="trade_name">
                            <uni-easyinput type="text" v-model="form['trade_name']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','trade_name')) || (!form['after_sales_application_id'] && $check_field('add','trade_name'))" :disabled="disabledObj['trade_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','product_type') || ($check_field('add','product_type') || $check_field('set','product_type'))" label="商品类型" name="product_type">
                            <uni-easyinput type="text" v-model="form['product_type']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','product_type')) || (!form['after_sales_application_id'] && $check_field('add','product_type'))" :disabled="disabledObj['product_type_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','supplier_user') || ($check_field('add','supplier_user') || $check_field('set','supplier_user'))" label="供货商用户" name="supplier_user">
                  ...
                  v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','supplier_user')) || (!form['after_sales_application_id'] && $check_field('add','supplier_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['supplier_user']"
                  :localdata="list_user_supplier_user"
              ...
              <uni-forms-item v-if="$check_field('get','supplier_name') || ($check_field('add','supplier_name') || $check_field('set','supplier_name'))" label="供货商名" name="supplier_name">
                            <uni-easyinput type="text" v-model="form['supplier_name']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','supplier_name')) || (!form['after_sales_application_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','after_sales_quantity') || ($check_field('add','after_sales_quantity') || $check_field('set','after_sales_quantity'))" label="售后数量" name="after_sales_quantity">
                            <uni-easyinput type="text" v-model="form['after_sales_quantity']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','after_sales_quantity')) || (!form['after_sales_application_id'] && $check_field('add','after_sales_quantity'))" :disabled="disabledObj['after_sales_quantity_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || ($check_field('add','user_name') || $check_field('set','user_name'))" label="用户名称" name="user_name">
                  ...
                  v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','user_name')) || (!form['after_sales_application_id'] && $check_field('add','user_name'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_name']"
                  :localdata="list_user_user_name"
              ...
              <uni-forms-item v-if="$check_field('get','consignee') || ($check_field('add','consignee') || $check_field('set','consignee'))" label="收货人" name="consignee">
                            <uni-easyinput type="text" v-model="form['consignee']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','consignee')) || (!form['after_sales_application_id'] && $check_field('add','consignee'))" :disabled="disabledObj['consignee_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','receiving_phone_number') || ($check_field('add','receiving_phone_number') || $check_field('set','receiving_phone_number'))" label="收货电话" name="receiving_phone_number">
                            <uni-easyinput type="text" v-model="form['receiving_phone_number']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','receiving_phone_number')) || (!form['after_sales_application_id'] && $check_field('add','receiving_phone_number'))" :disabled="disabledObj['receiving_phone_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','shipping_address') || ($check_field('add','shipping_address') || $check_field('set','shipping_address'))" label="收货地址" name="shipping_address">
                            <uni-easyinput type="text" v-model="form['shipping_address']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','shipping_address')) || (!form['after_sales_application_id'] && $check_field('add','shipping_address'))" :disabled="disabledObj['shipping_address_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','after_sales_issues') || ($check_field('add','after_sales_issues') || $check_field('set','after_sales_issues'))" label="售后问题" name="after_sales_issues">
                            <uni-easyinput type="text" v-model="form['after_sales_issues']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','after_sales_issues')) || (!form['after_sales_application_id'] && $check_field('add','after_sales_issues'))" :disabled="disabledObj['after_sales_issues_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','problem_description') || ($check_field('add','problem_description') || $check_field('set','problem_description'))" label="问题描述" name="problem_description">
                    <uni-easyinput type="textarea" v-model="form['problem_description']" v-if="user_group === '管理员' || (form['after_sales_application_id'] && $check_field('set','problem_description')) || (!form['after_sales_application_id'] && $check_field('add','problem_description'))" :disabled="disabledObj['problem_description_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/after_sales_application/upload?'),
