<template>
	<view class="page_after_sales_application diy_list diy_list_page div_list_tml" id="after_sales_application_list">
		<!-- 筛选模块(开始) -->
		<view>
						...
						<view class="">
							<!-- 搜索栏 -->
								...
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
																											...
																											<uni-search-bar placeholder="搜索售后问题" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'after_sales_issues')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
														<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?after_sales_application_id=' + o['after_sales_application_id']" class="btn btn-primary">查看详情</navigator>
