<template>
  <view class="page_after_sales_application diy_table diy_table_tml" id="after_sales_application_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/after_sales_application/view?" v-show="user_group == '管理员' || $check_action('/after_sales_application/table','add') || $check_action('/after_sales_application/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','after_sales_quantity')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>售后数量</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','after_sales_issues')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>售后问题</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/after_sales_application/table','del') || $check_action('/after_sales_application/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/after_sales_application/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/after_sales_application/table','set') || $check_action('/after_sales_application/view','set') || $check_action('/after_sales_application/view','get')" class="btn btn-primary">详情</navigator>
					                    																		<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/after_sales_results/view','add')" @click="to_form('/pages/after_sales_results/view',o)">
									<span>售后处理</span>
								</a>
																						</view>
			</view>
