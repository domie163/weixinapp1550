          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','supplier_user') || ($check_field('add','supplier_user') || $check_field('set','supplier_user'))" label="供货商用户" name="supplier_user">
                  ...
                  v-if="user_group === '管理员' || (form['consultation_records_id'] && $check_field('set','supplier_user')) || (!form['consultation_records_id'] && $check_field('add','supplier_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['supplier_user']"
                  :localdata="list_user_supplier_user"
              ...
              <uni-forms-item v-if="$check_field('get','supplier_name') || ($check_field('add','supplier_name') || $check_field('set','supplier_name'))" label="供货商名" name="supplier_name">
                            <uni-easyinput type="text" v-model="form['supplier_name']" v-if="user_group === '管理员' || (form['consultation_records_id'] && $check_field('set','supplier_name')) || (!form['consultation_records_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || ($check_field('add','user_name') || $check_field('set','user_name'))" label="用户名称" name="user_name">
                  ...
                  v-if="user_group === '管理员' || (form['consultation_records_id'] && $check_field('set','user_name')) || (!form['consultation_records_id'] && $check_field('add','user_name'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_name']"
                  :localdata="list_user_user_name"
              ...
              <uni-forms-item v-if="$check_field('get','consultation_topic') || ($check_field('add','consultation_topic') || $check_field('set','consultation_topic'))" label="咨询主题" name="consultation_topic">
                            <uni-easyinput type="text" v-model="form['consultation_topic']" v-if="user_group === '管理员' || (form['consultation_records_id'] && $check_field('set','consultation_topic')) || (!form['consultation_records_id'] && $check_field('add','consultation_topic'))" :disabled="disabledObj['consultation_topic_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','consultation_content') || ($check_field('add','consultation_content') || $check_field('set','consultation_content'))" label="咨询内容" name="consultation_content">
                    <uni-easyinput type="textarea" v-model="form['consultation_content']" v-if="user_group === '管理员' || (form['consultation_records_id'] && $check_field('set','consultation_content')) || (!form['consultation_records_id'] && $check_field('add','consultation_content'))" :disabled="disabledObj['consultation_content_isDisabled']" />
                <!-- 仅查看 -->
