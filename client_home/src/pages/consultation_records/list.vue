<template>
	<view class="page_consultation_records diy_list diy_list_page div_list_tml" id="consultation_records_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
																<uni-search-bar placeholder="搜索咨询主题" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'consultation_topic')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?consultation_records_id=' + o['consultation_records_id']" class="btn btn-primary">查看详情</navigator>
