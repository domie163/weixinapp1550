<template>
	<view class="diy_details diy_div_after_sales_results">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','after_sales_processing')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>售后处理:</span>
						</view>
							<view class="diy_field diy_text">
							<text>
								{{obj["after_sales_processing"]}}
							</text>
						</view>
						</view>
					<view v-if="$check_field('get','after_sales_remarks')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>售后备注:</span>
						</view>
							<view class="diy_field diy_desc">
							<text>
								{{ obj["after_sales_remarks"] }}
							</text>
						</view>
						</view>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/after_sales_results/get_obj", {
					after_sales_results_id:this.query.after_sales_results_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["after_sales_results_id"] !==0) {
...
<style scoped>
	.div_after_sales_results_details {}
