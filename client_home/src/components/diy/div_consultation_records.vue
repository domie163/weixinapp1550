<template>
	<view class="diy_details diy_div_consultation_records">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/reply_record/edit')" v-if="$check_action('/reply_record/edit','add') || $check_action('/reply_record/edit','set')" >回复</button>
					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/consultation_records/get_obj", {
					consultation_records_id:this.query.consultation_records_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["consultation_records_id"] !==0) {
...
<style scoped>
	.div_consultation_records_details {}
