	...
	<view class="diy_details diy_div_product_information">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					<view v-if="$check_field('get','commodity_map')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>商品图:</span>
						</view>
							<view class="diy_field diy_img">
							<image style="width:100%;height:auto;" :src="$fullUrl(obj['commodity_map'])" mode="widthFix"></image>
						</view>
						</view>
					...
					<view v-if="$check_field('get','stock')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>库存:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','product_introduction')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>商品介绍:</span>
						</view>
							<view class="diy_field diy_desc">
							<text>
								{{ obj["product_introduction"] }}
							</text>
						</view>
						</view>
				</view>
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/appointment_order/edit')" v-if="$check_action('/appointment_order/edit','add') || $check_action('/appointment_order/edit','set')" >预约订单</button>
					</view>
				</view>
			</view>
		</view>
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/live_booking/edit')" v-if="$check_action('/live_booking/edit','add') || $check_action('/live_booking/edit','set')" >直播预约</button>
					</view>
				</view>
			</view>
		</view>
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/consultation_records/edit')" v-if="$check_action('/consultation_records/edit','add') || $check_action('/consultation_records/edit','set')" >咨询商家</button>
					</view>
				</view>
			</view>
		</view>
