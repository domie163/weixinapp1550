	...
	<view class="diy_details diy_div_cancellation_of_order">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/cancel_confirmation/edit')" v-if="$check_action('/cancel_confirmation/edit','add') || $check_action('/cancel_confirmation/edit','set')" >取消确认</button>
					</view>
				</view>
			</view>
		</view>
