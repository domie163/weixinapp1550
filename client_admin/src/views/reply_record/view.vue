	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="供货商用户" prop="supplier_user">
													<el-select v-if="user_group === '管理员' || (form['reply_record_id'] && $check_field('set','supplier_user')) || (!form['reply_record_id'] && $check_field('add','supplier_user'))" id="supplier_user" v-model="form['supplier_user']" :disabled="disabledObj['supplier_user_isDisabled']">
				...
				<el-form-item label="供货商名" prop="supplier_name">
							  ...
							  v-if="user_group === '管理员' || (form['reply_record_id'] && $check_field('set','supplier_name')) || (!form['reply_record_id'] && $check_field('add','supplier_name'))" :disabled="disabledObj['supplier_name_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','supplier_name')">{{form['supplier_name']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户名称" prop="user_name">
													<el-select v-if="user_group === '管理员' || (form['reply_record_id'] && $check_field('set','user_name')) || (!form['reply_record_id'] && $check_field('add','user_name'))" id="user_name" v-model="form['user_name']" :disabled="disabledObj['user_name_isDisabled']">
				...
				<el-form-item label="咨询主题" prop="consultation_topic">
							  ...
							  v-if="user_group === '管理员' || (form['reply_record_id'] && $check_field('set','consultation_topic')) || (!form['reply_record_id'] && $check_field('add','consultation_topic'))" :disabled="disabledObj['consultation_topic_isDisabled']"></el-input>
				...
				<el-form-item label="回复内容" prop="reply_content">
						...
						v-if="user_group === '管理员' || (form['reply_record_id'] && $check_field('set','reply_content')) || (!form['reply_record_id'] && $check_field('add','reply_content'))" :disabled="disabledObj['reply_content_isDisabled']"></el-input>
