		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="供货商用户" prop="supplier_user">
												<el-input id="supplier_user" v-model="form_sub['supplier_user']" placeholder="请输入供货商用户"
							  v-if="user_group === '管理员' || (form_sub['supplier_id'] && $check_field('set','supplier_user')) || (!form_sub['supplier_id'] && $check_field('add','supplier_user'))"></el-input>
					<div v-else-if="$check_field('get','supplier_user')">{{form_sub['supplier_user']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="供货商名" prop="supplier_name">
												<el-input id="supplier_name" v-model="form_sub['supplier_name']" placeholder="请输入供货商名"
