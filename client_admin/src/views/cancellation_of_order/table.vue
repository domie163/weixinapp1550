<template>
	<el-main class="bg table_wrap">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/cancellation_of_order/table','set') || $check_action('/cancellation_of_order/view','set') || $check_action('/cancellation_of_order/view','get') || $check_action('/取消确认/table','add') || $check_action('/取消确认/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/cancellation_of_order/table','set') || $check_action('/cancellation_of_order/view','set') || $check_action('/cancellation_of_order/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/cancel_confirmation/view')" v-if="user_group == '管理员' || $check_action('/cancel_confirmation/table','add') || $check_action('/cancel_confirmation/view','add')">
						<span>取消确认</span>
					</el-button>
							</template>
			</el-table-column>
